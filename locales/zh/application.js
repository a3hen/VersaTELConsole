...
module.exports = {
  ...
  TIP_APP_TYPE:
    'mistyPLX Manager 支持来自于应用商店和应用仓库的应用部署(基于 Helm)，同样也支持自制应用 (Application CRD)。',
  TIP_APP_GOVERNANCE:
    '使用应用治理需要创建自制应用并对每项服务开启服务治理功能',
  APP_REPOS_DESC:
    '应用仓库来自于第三方的 Helm Chart Repo，通过可视化的方式在 mistyPLX Manager 中展示并提供部署及管理功能，用户可以基于应用仓库中的模板快速地一键部署应用。',
