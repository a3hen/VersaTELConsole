module.exports = {
  ...
  'Create Remote Backup Cluster': '创建远程传输任务',
  'remote backup task name': '远程备份任务名称',
  'Automatic incremental backup intervals': '自动增量备份时间间隔',
  ...
  'Create automated remote backups': '新建远程传输任务',
  'backup_cluster': '备份集群',
  ...
  REMOTEBACKUP_DESC: '远程备份描述',
  Remotebackup1_PL: '远程备份',
  REMOTEBACKUP1_DESC: '远程备份描述',
  Remotebackup2_PL: '远程备份',
  REMOTEBACKUP2_DESC: '远程备份描述',
  r_cluster: '远程备份集群',
  r_task: '远程备份任务管理',
  r_auto: '自动远程备份任务管理',
