...
module.exports = {
  ...
  'Type of LINSTOR Node': 'LINSTOR节点的类型，请选择需要的节点类型',
  Modify: '修改',
  'Modify LINSTOR Node': '修改LINSTOR节点',
  Storagepool: '存储池',
  STORAGEPOOL_DESC:
  ...
  'Select LINSTOR Node': '选择LINSTOR节点',
  'Volume name': 'LVM设备名',
  LVM_VOLUME_NAME_DESC: '请选择LVM设备以用于存储池创建',
  'Select LVM Type': '选择LVM类型',
  LRESOURCE_DESC: '提供了当前LINSTOR集群下资源的状态，以及可以创建删除资源',
