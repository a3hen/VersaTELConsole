module.exports = {
  ...
  LNODE: '节点',
  LNode: 'VishinStor K3000 统一管理系统 集群节点',
  LNODE_DESC:
    '提供了当前 VishinStor K3000 统一管理系统 集群下节点的运行状态，以及可以创建和删除 VishinStor K3000 统一管理系统 节点',
  'Node Type': '节点类型',
  'LVM Type': 'LVM 类型',
  'Storagepool Num': '存储池数量',
  'Resource Num': '资源数量',
  LNODE_CREATE_DESC: '创建 VishinStor K3000 统一管理系统 集群节点',
  LNODE_EMPTY_DESC: '请创建一个节点',
  'Create VersaSDS Node': '创建 VishinStor K3000 统一管理系统 集群节点',
  'Please input VersaSDS Node name': '请输入 VishinStor K3000 统一管理系统 节点名称',
  VTEL_NAME_DESC:
  ...
  'IP Address of VersaSDS Node': 'VishinStor K3000 统一管理系统 节点的 IP 地址，须符合 IP 地址格式',
  'Type of VersaSDS Node': 'VishinStor K3000 统一管理系统 节点的类型，请选择需要的节点类型',
  'Invalid IP': 'IP地址格式错误',
  Modify: '修改',
  'Modify VersaSDS Node': '修改 VishinStor K3000 统一管理系统 节点',
  Storagepool: '存储池',
  STORAGEPOOL_DESC:
    '提供了当前 VishinStor K3000 统一管理系统 集群下存储池的状态，以及可以创建和删除存储池',
  ...
  'Select VersaSDS Node': '选择 VishinStor K3000 统一管理系统 节点',
  'Volume name': 'LVM 设备名',
  LVM_VOLUME_NAME_DESC: '请选择 LVM 设备以用于存储池创建',
  'Select LVM Type': '选择 LVM 类型',
  LRESOURCE_DESC:
    '提供了当前 VishinStor K3000 统一管理系统 集群下资源的状态，以及可以创建和删除资源',
  ...
  Snapshot_PL: '快照',
  SSnapshot_PL: '快照',
  SNAPSHOT_DESC: '使用 VishinStor K3000 统一管理系统 集群中的快照功能，您可以轻松创建、管理和操作资源的快照，以提供恢复资源和版本控制的能力',
  SSNAPSHOT_DESC: '使用 VishinStor K3000 统一管理系统 集群中的快照功能，您可以轻松创建、管理和操作资源的快照，以提供恢复资源和版本控制的能力',
  ...
  ISCSIMAPPING_DESC: '通过iSCSI映射，存储资源可以通过TCP/IP网络作为远程存储设备提供给主机发起端。您可以在此页面实现 iSCSI 映射管理。',
  iSCSIMapping1_PL: 'iSCSI映射',
  ISCSIMAPPING1_DESC: '通过iSCSI映射，存储资源可以通过TCP/IP网络作为远程存储设备提供给主机发起端。您可以在此页面实现 iSCSI 映射管理。',
  iSCSIMapping2_PL: 'iSCSI映射',
  ISCSIMAPPING2_DESC: '通过iSCSI映射，存储资源可以通过TCP/IP网络作为远程存储设备提供给主机发起端。您可以在此页面实现 iSCSI 映射管理。',
  INITIATOR: '发起端主机',
  ...
  Snapshots: '存储卷快照',
  LNode_LOW: 'VishinStor K3000 统一管理系统 节点',
  Storagepool_LOW: '存储池',
  LResource_LOW: '资源',
  Name: '名称',
  ...
  LResource_PL: '资源',
  LNode_PL: 'VishinStor K3000 统一管理系统 节点',
  InUse: '使用中',
  Unused: '未使用',
  Synching: '同步中',
  Connecting: '连接中',
