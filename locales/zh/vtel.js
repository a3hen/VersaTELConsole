...
module.exports = {
  ...
  SEARCH_BY_RESOURCE_TYPE_AUDIT: '按审计对象 - 类型搜索',
  AUDIT_LOG_RESOURCE_TYPE_AUDIT_TIP: '输入审计对象 - 类型查找审计日志。',
  SEARCH_BY_RESOURCE_NAME_AUDIT: '按审计对象 - 名称搜索',
  AUDIT_LOG_RESOURCE_NAME_AUDIT_TIP: '输入审计对象 - 名称查找审计日志。',
