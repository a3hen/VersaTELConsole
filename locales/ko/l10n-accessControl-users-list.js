...
module.exports = {
  ...
  PLATFORM_ROLE_DESC: 'Set the role of the user on the CoSAN Manager platform.',
  USER_SETTING_EMAIL_DESC: 'The email address can be used to log in to the CoSAN Manager web console.',
