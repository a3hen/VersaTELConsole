...
module.exports = {
  ...
  SERVICE_TYPES_A:
    'mistyPLX Manager supports stateless services and stateful services. Pod replicas in a stateless service share the same volume, while each pod replica in a stateful service has an independent volume.',
