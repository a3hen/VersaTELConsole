...
module.exports = {
  ...
  NOTIFICATION_CONFIGURATION_DESC:
    'CoSAN Manager supports notification configuration for multiple notification channels. You can set servers and recipients, and enable or disable notifications.',
