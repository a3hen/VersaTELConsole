...
module.exports = {
  ...
  'rules desc':
    'mistyPLX Manager puede recopilar registros de auditoría de operación de acuerdo con las reglas que establezcas. Haga clic para ver cómo definir las reglas.',
  EVENT_CREATE_DESC:
  ...
  USER_GUIDES_DESC: 'La guía de usuario más completa de mistyPLX Manager.',
  DEVELOPER_DESC:
    'Haz una pregunta en la comunidad de desarrolladores para obtener ayuda.',
  API_DOCS_DESC: 'La documentación más completa de la API de mistyPLX Manager.',
  GITHUB_ISSUES_DESC:
