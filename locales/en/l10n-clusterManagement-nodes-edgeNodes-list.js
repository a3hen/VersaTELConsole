...
module.exports = {
  ...
  EDGE_NODE_DESC: 'Edge nodes are servers deployed outside the MistyPLX Manager cluster. You can add edge nodes to the MistyPLX Manager cluster to manage them.',
  // Node Count
  ...
  EDGENODE_INTERNAL_IP_DESC: 'Set the internal IP address of the edge node in the MistyPLX Manager cluster.',
  EDGENODE_INTERNAL_IP_EMPTY_DESC: 'Please set the internal IP address of the edge node in the MistyPLX Manager cluster.',
