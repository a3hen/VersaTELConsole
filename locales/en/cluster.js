...
module.exports = {
  ...
  CHOOSE_PROVIDER_DESC: 'mistyPLX Manager provides a solution for quickly deploying Kubernetes clusters among mainstream service providers',
  ...
  CLUSTER_API_SERVER_DESC: 'You need to input the mistyPLX Manager API Server address to be added to the cluster',
