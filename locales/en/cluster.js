...
module.exports = {
  ...
  CHOOSE_PROVIDER_DESC: 'CoSAN Manager provides a solution for quickly deploying Kubernetes clusters among mainstream service providers',
  ...
  CLUSTER_API_SERVER_DESC: 'You need to input the CoSAN Manager API Server address to be added to the cluster',
