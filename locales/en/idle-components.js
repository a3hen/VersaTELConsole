...
module.exports = {
  ...
  NODE_INTERNAL_IP_DESC: 'Set the internal IP address of the node in the CoSAN Manager cluster.',
  NODE_INTERNAL_IP_EMPTY_DESC: 'Please set the internal IP address of the node in the CoSAN Manager cluster.',
