...
module.exports = {
  ...
  APP_TEMPLATE_DESC: 'CoSAN Manager provides full lifecycle management for apps. You can upload or create new app templates and test them quickly. In addition, you can publish your apps to the App Store so that other users can deploy with one click.',
  DEVELOP_APP_DESC: 'You can upload Helm charts or use the resource orchestration tool provided by CoSAN Manager to develop app templates.',
