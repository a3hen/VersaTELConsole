...
module.exports = {
  ...
  PLATFORM_ROLE_DESC: 'Set the role of the user on the MistyPLX Manager platform.',
  USER_SETTING_EMAIL_DESC: 'The email address can be used to log in to the MistyPLX Manager web console.',
