...
module.exports = {
  ...
  APP_TEMPLATE_CREATE_DESC: 'CoSAN Manager provides full lifecycle management for apps. You can upload or create new app templates and test them quickly. In addition, you can publish your apps to the App Store so that other users can deploy with one click.',
  APP_TEMPLATES_DESC: 'CoSAN Manager provides full lifecycle management for apps. You can upload or create new app templates and test them quickly. In addition, you can publish your apps to the App Store so that other users can deploy with one click.',
  HOW_APP_DEPLOY_TITLE: 'How to deploy and test applications',
  APPS_CREATE_DESC: 'CoSAN Manager provides lifecycle management of app templates. You can upload or create new app templates and test them quickly. In addition, you can publish your app templates to the App Store so that other users can deploy them.',
  ...
  RESOURCE_TOOL_DESCRIPTION: 'CoSAN Manager provides a visual resource orchestration tool that allows you to' +
