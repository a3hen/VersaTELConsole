...
module.exports = {
  ...
  ACCOUNT_ROLE_DESC: 'The role of an account defines the permissions of the account on the mistyPLX Manager platform.',
  ACCOUNT_ROLE_CREATE_DESC: 'The role of an account defines the permissions of the account on the mistyPLX Manager platform.',
