...
module.exports = {
  ...
  SERVICE_COMPONENTS_DESC:
    'System components are software components in the CoSAN Manager system, which provide various functions. You can view the running status of services components on this page.',
  // KubeSphere
  STOPPED: 'Stopped',
