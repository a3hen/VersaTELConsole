...
@inject('detailStore')
@observer
export default class DisklessResource extends React.Component {
  constructor(props) {
    super(props)

    this.disklessResourceStore =
      props.disklessResourceStore || new DisklessResourceStore()
  }
  ...
  handleFetch = (params = {}) => {
    ...
    this.disklessResourceStore.fetchList({
      name,
      cluster,
      ...params,
    })
