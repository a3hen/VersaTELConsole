...
@observer
@withList({
  store: new TPResourceStore(),
  module: 'tpresources', // 图标类型,utils/constants中定义
  authKey: 'tpresource',
  name: 'TPResource',
})
export default class TPResource extends React.Component {
  // constructor(props) {
  //   super(props)
  // }
      ...
      selectActions: [
        {
          ...
          action: 'delete',
          onClick: () =>
            trigger('tpresource.batch.delete', {
              type: 'TPResource',
              rowKey: 'name',
              success: routing.query,
  ...
  showCreate = () => {
    ...
    return trigger('tpresource.create', {
      title: t('Create ThinPool resource'),
      node: name,
      TPResourceTemplates: toJS(this.store.TPResourceTemplates.data),
      success: getData,
    })
  }
  ...
  render() {
    ...
    return (
      <Card
        title={t('Display the message of ThinPool Resource')}
        loading={false}
