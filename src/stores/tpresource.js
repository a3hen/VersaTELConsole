...
export default class TPResourceStore extends Base {
  TPResourceTemplates = new List()

  getResourceUrl = () => `/kapis/versatel.kubesphere.io/v1alpha1/thinpool`

  getListUrl = this.getResourceUrl

  constructor(module = 'tpresources') {
    super(module)
  }
  ...
  @action
  async fetchTPResourceTemplates() {
    this.TPResourceTemplates.isLoading = true
    ...
    this.TPResourceTemplates.update({
