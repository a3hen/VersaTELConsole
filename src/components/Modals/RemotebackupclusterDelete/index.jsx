...
export default class RemoteBackupClusterDeleteModal extends React.Component {
  ...
  render() {
    ...
    const title = 'delete remote backup cluster'
    ...
    return (
      <Modal.Form
        ...
        disableOk={this.state.confirm !== this.props.remotename}
      >
        <p style={{ marginBottom: '10px', opacity: 0.7 }}>请输入此集群的名称 {this.props.remotename} 以确认您了解此操作的风险。</p>
        <Input
          name="confirm"
          value={this.state.confirm}
          onChange={this.handleInputChange}
          placeholder={this.props.remotename}
          autoFocus={true}
        />
      </Modal.Form>
    )
